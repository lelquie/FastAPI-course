...
from schemas import PostResponse, UserCreate, UserUpdate, UserPublic, UserPrivate, Token, PaginatedPostResponse, ChangePasswordRequest, ForgotPasswordRequest, ResetPasswordRequest
...
async def update_user(
    ...
    if user_id != current_user.id:
        raise HTTPException(
            ...
            detail="Not authorized to update the user's profile"
        )
